  ...
  ({ title, description, variant, className, ...props }, ref) => (
    <div className="flex w-full max-w-[520px] gap-2.5">
      <CheckboxPrimitive.Root
        ref={ref}
        className={cn(
          "peer mt-[2px] h-5 w-5 shrink-0 rounded-lg border border-gray30 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-darkGreen focus-visible:ring-offset-2 disabled:cursor-not-allowed data-[state=checked]:border-greenGradientColor2 data-[state=checked]:bg-gradient-green2 data-[state=checked]:text-white",
          variant === "simple" &&
